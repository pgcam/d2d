...
___add( 'col1', 'category' );
function ___col1_category(){

	$loop = new D2D_Cat_Restaurant();
	$loop->loop();
...
class D2D_Cat_Restaurant extends Gidd_WP_Loop{
	...
	function loop(){
		...
		$cat = get_last_segment( gidd_current_url() );
		$wp_query->query( array( 'posts_per_page' => -1, 'post_type' => 'gd_restaurant', 'order' => 'asc', 'orderby' => 'title', 'category_name' => $cat  ) );
